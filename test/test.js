...
describe('general stopwordiness:', function () {
  ...
  it('should remove hindu stopwords', function () {
    const oldString = 'सूत्रों ने बताया कि ऊर्जा मंत्रालय के अंतर्गत काम करने वाले ब्यूरो ऑफ एनर्जी एफ़िशंसी एक योजना पर काम कर रहा है। मकसद ऐसे घरों को बढ़ावा देना है जहां ऊर्जा का प्रभावशाली इस्तेमाल हो सके। यानी यहां रोशनी या कूलिंग के लिए संसाधनों की कम डिमांड विकसित की जा सके। इसी कोशिश के तहत वर्तमान रेजिडेंशल इमारतों में भी नए उपकरणों का इस्तेमाल करके ऊर्जा के कम और प्रभावशाली इस्तेमाल को बढ़ावा देना है। बता दें कि मोदी सरकार की ओर से उजाला स्कीम ऊर्जा संसाधनों के बेहतर इस्तेमाल की दिशा में ही उठाया गया कदम है। इसके तहत सरकार ने पुराने फिलामेंट वाले और सीएफएल बल्बों को आधुनिक एलईडी लाइट्स से बदला है। बढ़ते शहरी दायरे और पर्यावरण पर पड़ते प्रभाव के मद्देनजर के जरिए सरकारी कोशिशों को नई ताकत मिलने की उम्मीद है। इससे प्रॉपर्टी सेक्टर में नौकरियां पैदा होने की भी पूरी गुंजाइश है।'.split(' ')
    const newString = sw.removeStopwords(oldString, sw.hi) 
    newString.should.eql([ 'सूत्रों', 'ने', 'बताया', 'कि', 'ऊर्जा', 'मंत्रालय', 'के', 'अंतर्गत', 'काम', 'करने', 'वाले', 'ब्यूरो', 'ऑफ', 'एनर्जी', 'एफ़िशंसी', 'एक', 'योजना', 'पर', 'काम', 'कर', 'रहा', 'है।', 'मकसद', 'ऐसे', 'घरों', 'को', 'बढ़ावा', 'देना', 'है', 'जहां', 'ऊर्जा', 'का', 'प्रभावशाली', 'इस्तेमाल', 'हो', 'सके।', 'यानी', 'यहां', 'रोशनी', 'या', 'कूलिंग', 'के', 'लिए', 'संसाधनों', 'की', 'कम', 'डिमांड', 'विकसित', 'की', 'जा', 'सके।', 'इसी', 'कोशिश', 'के', 'तहत', 'वर्तमान', 'रेजिडेंशल', 'इमारतों', 'में', 'भी', 'नए', 'उपकरणों', 'का', 'इस्तेमाल', 'करके', 'ऊर्जा', 'के', 'कम', 'और', 'प्रभावशाली', 'इस्तेमाल', 'को', 'बढ़ावा', 'देना', 'है।', 'बता', 'दें', 'कि', 'मोदी', 'सरकार', 'की', 'ओर', 'से', 'उजाला', 'स्कीम', 'ऊर्जा', 'संसाधनों', 'के', 'बेहतर', 'इस्तेमाल', 'की', 'दिशा', 'में', 'ही', 'उठाया', 'गया', 'कदम', 'है।', 'इसके', 'तहत', 'सरकार', 'ने', 'पुराने', 'फिलामेंट', 'वाले', 'और', 'सीएफएल', 'बल्बों', 'को', 'आधुनिक', 'एलईडी', 'लाइट्स', 'से', 'बदला', 'है।', 'बढ़ते', 'शहरी', 'दायरे', 'और', 'पर्यावरण', 'पर', 'पड़ते', 'प्रभाव', 'के', 'मद्देनजर', 'के', 'जरिए', 'सरकारी', 'कोशिशों', 'को', 'नई', 'ताकत', 'मिलने', 'की', 'उम्मीद', 'है।', 'इससे', 'प्रॉपर्टी', 'सेक्टर', 'में', 'नौकरियां', 'पैदा', 'होने', 'की', 'भी', 'पूरी', 'गुंजाइश', 'है।' ])
  })
